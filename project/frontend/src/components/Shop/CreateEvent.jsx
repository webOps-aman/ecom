  ...
  return (
    <div className="w-[90%] 800px:w-[50%] bg-white shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <br />
        <input type="submit" value="Create" className="mt-2 cursor-pointer w-full px-3 h-[35px] border rounded-[3px] focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
      </form>
    </div>
  );
};
